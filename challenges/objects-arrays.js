...
class Dinosaur{
  ...
  //putting this here because most dinosaurs probably had a roar.
  roar(){
    return "RAWERSRARARWERSARARARRRR";
  }
}
// tyrannosaurus, carnivorous, 7000kg, 12m, Late Cretaceous
const sharptooth = new Dinosaur({
  name: 'tyrannosaurus',
  diet:'carnivorous',
  weight: '7000kg',
  length: '12m',
...
console.log(sharptooth.weight);

// What was the diet of a velociraptor?
console.log(fastbiters.diet);

// How long was a stegosaurus?
console.log(spike.length);

// What time period did tyrannosaurus live in?
console.log(sharptooth.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(sharptooth.roar());
...
*/
const populationTotal = zooAnimals.reduce(function(populationTotal, item){
  return populationTotal += parseInt(item.population)
})
